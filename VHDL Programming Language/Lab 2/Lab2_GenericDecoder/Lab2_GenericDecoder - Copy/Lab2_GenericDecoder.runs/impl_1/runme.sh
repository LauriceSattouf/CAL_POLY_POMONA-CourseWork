...
HD_PWD='C:/Users/Lauri/Downloads/Lab2_GenericDecoder/Lab2_GenericDecoder - Copy/Lab2_GenericDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nbitdec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nbitdec.tcl -notrace
